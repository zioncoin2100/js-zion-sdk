  ...
  describe('FederationServer.resolveAddress', function() {
    beforeEach(function() {
      this.axiosMock
        ...
        .withArgs(
          sinon.match(
            'https://acme.com:1337/federation?type=name&q=bob%2Azion.org'
          )
        )
        .returns(
          Promise.resolve({
            data: {
              zion_address: 'bob*zion.org',
              account_id:
    ...
    it('requests is correct', function(done) {
      this.server
        ...
        .then((response) => {
          expect(response.zion_address).equals('bob*zion.org');
...
`
      ...
      this.axiosMock
        ...
        .withArgs(
          sinon.match(
            'https://api.zion.org/federation?type=name&q=bob%2Azion.org'
          )
        )
        .returns(
          Promise.resolve({
