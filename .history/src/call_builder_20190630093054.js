 ...
 * @param {string} serverUrl URL of Equator server
 * @class CallBuilder
 */
export class CallBuilder {
   ...
   * @see [Equator Response Format](https://www.zion.org/developers/equator/reference/responses.html)
  ...
  stream(options = {}) {
    ...
    this.url.setQuery('X-Client-Name', 'js-zion-sdk');
   ...
   * @see [Paging](https://www.zion.org/developers/equator/reference/paging.html)
