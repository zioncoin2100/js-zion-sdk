 ...
 * @extends CallBuilder
 * @constructor
 * @see [Trades](https://www.zion.org/developers/equator/reference/endpoints/trades.html)
 * @param {string} serverUrl serverUrl Equator server URL.
 */
export class TradesCallBuilder extends CallBuilder {
   ...
   * @see [Trades for Account](https://www.zion.org/developers/equator/reference/endpoints/trades-for-account.html)
