 ...
 *
 * @see [All Operations](https://www.zion.org/developers/equator/reference/endpoints/operations-all.html)
...
export class OperationCallBuilder extends CallBuilder {
   ...
   * @see [Operation Details](https://www.zion.org/developers/equator/reference/endpoints/operations-single.html)
   ...
   * @see [Operations for Account](https://www.zion.org/developers/equator/reference/endpoints/operations-for-account.html)
   ...
   *
   * @see [Operations for Ledger](https://www.zion.org/developers/equator/reference/endpoints/operations-for-ledger.html)
   ...
   * @see [Operations for Transaction](https://www.zion.org/developers/equator/reference/endpoints/operations-for-transaction.html)
